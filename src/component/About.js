      ...
      <div className="container about">
        ...
        <div className="row d-flex align-items-center pt-2">
          <div className="col-lg-6">
            ...
            <ul className="ul">
              <li>
                <i className="bi bi-check-lg"></i> This is best way earn.
              </li>
              <li>
                <i className="bi bi-check-lg"></i> You know are the best.
              </li>
              <li>
                <i className="bi bi-check-lg"></i> Yes you can do it this.
              </li>
            </ul>
            <br></br>
            <button type="button" className="outBtn">
      ...
      <div className="container-fluid template">
        <div className="container text-center about-2">
          <h2 className="choco capitalize">
            when a man's stomach is full it makes no diffrence whether he is
            rish or poor.
          </h2>
          <p className="grey">
            It is a long established fact that a reader will be distracted by
