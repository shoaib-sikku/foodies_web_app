    ...
    <>
      <div className="container explore">
        ...
        <p className="grey">
          ...
          velit natus repellat consequatur eveniet veniam esse alias molestiae
          magnam? Exercitationem odit perspiciatis ea libero dolorem error fugit
          sint praesentium doloremque optio deserunt quo ipsam, aliquam neque?
          Consequuntur, iusto praesentium.
        </p>
        <div className="row">
